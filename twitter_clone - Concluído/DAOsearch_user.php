...
//Fazendo autenticação de sessão para não ser acessado direto via URL
...
$query = "SELECT u.*, us.* FROM users AS u LEFT JOIN user_follow AS us ON (us.id_user = '$id_user' AND u.id = us.follow_id_user) WHERE u.name like '%$search%' AND u.id <> '$id_user'";
